...
GRPC_MAX_RECEIVE_MESSAGE_LENGTH = env.int('GRPC_MAX_RECEIVE_MESSAGE_LENGTH', 90 * 1024 * 1024)
GRPC_MAX_SEND_MESSAGE_LENGTH = env.int('GRPC_MAX_SEND_MESSAGE_LENGTH', 90 * 1024 * 1024)
